        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link to="/for-brands" className="hover:text-white transition-colors">
                  For Brands
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 mb-6">
          <div className="grid md:grid-cols-3 gap-6 text-gray-400">
            <div>
              ...
              <p>hello@drively.com</p>
              <p>support@drively.com</p>
            </div>
            <div>
        ...
        <div className="border-t border-gray-800 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2024 Drively Inc. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986s11.987-5.368 11.987-11.986C24.014 5.367 18.635.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.328-1.297L6.573 14.24c.529.529 1.297.847 2.135.847.529 0 1.017-.159 1.427-.407l1.388 1.388c-.688.529-1.547.92-2.448.92h-.626zm7.424 0c-.9 0-1.759-.391-2.448-.92l1.388-1.388c.41.248.898.407 1.427.407.838 0 1.606-.318 2.135-.847l1.452 1.451c-.88.807-2.031 1.297-3.328 1.297h-.626z"/>
                </svg>
              </a>
            </div>
          </div>
